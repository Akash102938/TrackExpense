...
const TransactionItem = ({
  ...
  const itemId = transaction._id || transaction.id;
        ...
        <div className={transactionItemStyles.contentContainer}>
          {isEditing ? (
            <>
              ...
              />
              {errors.description && (
                <p className={transactionItemStyles.errorText} id={`desc-error-${itemId}`}>
                  {errors.description}
                </p>
              )}
            </>
      ...
      <div className={transactionItemStyles.actionsContainer}>
        <div className={transactionItemStyles.amountContainer}>
          {isEditing ? (
            ...
            <span className={transactionItemStyles.amountText(amountClass, classes)}>
              {sign}$
