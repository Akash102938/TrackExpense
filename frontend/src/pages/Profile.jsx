...
// Sub-component moved outside to prevent re-creation on render
...
function Profile({ onUpdateProfile, onLogout }) {
  ...
  const handleApiRequest = useCallback(
    async (method, getEndPoints, data = null) => {
        ...
        try {
            ...
            const config = {
                method,
                url: `${BASE_URL}${getEndPoints}`, // FIXED: replaced 'endpoint' with 'getEndPoints'
  ...
  const handlePasswordSubmit = async (e) => {
    e.preventDefault(); // FIXED: corrected typo from 'prevenDefault' to 'preventDefault'
      ...
      <div className={profileStyles.mainContainer}>
         ...
         <div className={profileStyles.content}>
           <div className={profileStyles.grid}>
              ...
              <div className={profileStyles.card}>
                <h2 className={profileStyles.cardTitle}>
                  <Lock className={profileStyles.icon}/> {/* FIXED: Lock is now imported */}
                  Account Security
                </h2>
